							...
							<ul>
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="{{ asset('assets/images/post-small-image1.jpg') }}" alt="PRODUCT">
									</a>
								...
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="{{ asset('assets/images/post-small-image2.jpg') }}" alt="PRODUCT">
									</a>
								...
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="{{ asset('assets/images/post-small-image3.jpg') }}" alt="PRODUCT">
									</a>
