                        ...
                        <div class="col-2" style="text-align :center;">
                            <form method="POST" action="{{ route('cart.update_cart', $cart->cart_id) }}">
                                ...
                                <div class="cart_quantity_button" style="display: flex;width: 60%;" >
                                    <button type="submit" class="cart_quantity_down"  style="padding-right: 15px;" name="cart_status" value="cart_quantity_down"> - </button>
                                    ...
                                    <button type="submit" class="cart_quantity_up" style="padding-left: 15px;" name="cart_status" value="cart_quantity_up"> + </button>
                                </div>
                            </form>
                        </div>
